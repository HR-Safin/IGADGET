  ...
  return (
    <>
      ...
      <footer className="w-full text-emerald-200">
        <div className="flex float-right text-white  bg-blue-600 text-3xl rounded-2xl mr-8 mt-5 cursor-pointer">
        ...
        {/*    <!-- Main footer --> */}
        <div className="pt-16 pb-12 text-sm border-t border-emerald-600 bg-gradient-to-r from-blue-700 to-blue-500">
        ...
        {/*    <!-- Subfooter --> */}
        <div className="py-4 text-sm border-t border-emerald-700 bg-slate-200 text-black">
          <div className="container px-6 mx-auto">
            <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
              <div className="col-span-2 md:col-span-4 lg:col-span-6">
                Copyright 2022 iGADGET
              </div>
              <nav
